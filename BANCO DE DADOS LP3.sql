...
DROP TABLE LISTA_DE_COMPRA CASCADE constraints;
...
DROP TABLE ITEM_DA_LISTA CASCADE constraints;
CREATE TABLE ITEM_DA_LISTA(
ITEM_DA_LISTA_ID INT NOT NULL,
PRODUTO_ID INT NOT NULL,
LISTA_DE_COMPRA_ID INT NOT NULL,
QTD INTEGER,
TOTAL NUMERIC(10,2),
CONSTRAINT FK_PRODUTO_ITEM_DA_LISTA FOREIGN KEY(PRODUTO_ID) REFERENCES PRODUTO(PRODUTO_ID),
CONSTRAINT FK_LISTA_ITEM_DA_LISTA FOREIGN KEY(LISTA_DE_COMPRA_ID) REFERENCES LISTA_DE_COMPRA(LISTA_DE_COMPRA_ID),
CONSTRAINT PK_ITEM_DA_LISTA_ID PRIMARY KEY(ITEM_DA_LISTA_ID)
); 

DROP TABLE ITEM_DE_PEDIDO CASCADE constraints;
